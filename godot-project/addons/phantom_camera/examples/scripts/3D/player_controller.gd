...
const INPUT_MOVE_UP_STRINGNAME: StringName = "ui_up"
const INPUT_MOVE_DOWM_STRINGNAME: StringName = "ui_down"
const INPUT_MOVE_LEFT_STRINGNAME: StringName = "ui_left"
const INPUT_MOVE_RIGHT_STRINGNAME: StringName = "ui_right"
